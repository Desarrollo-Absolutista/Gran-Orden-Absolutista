...
type CheckFunction = (...any) -> (boolean, string?)

local t = {}

function t.type(typeName): CheckFunction
...
function t.typeof(typeName): CheckFunction
	return function(value)
...
**--]]
function t.keys(check: CheckFunction): CheckFunction
...
--[[**
	...
	@returns A function that will return true if the condition is passed
**--]]
function t.values(check: CheckFunction): CheckFunction
	assert(t.callback(check))
	return function(value)
		local tableSuccess, tableErrMsg = t.table(value)
		if tableSuccess == false then
...
--[[**
		...
		@returns A function that will return true if the condition is passed
	**--]]
	function t.array(check: CheckFunction): CheckFunction
		assert(t.callback(check))
...
--[[**
		...
		@returns A function that will return true if the condition is passed
	**--]]
	function t.strictArray(...: CheckFunction): CheckFunction
		local valueTypes = { ... }
		...
		return function(value)
			...
			for idx, typeFn in pairs(valueTypes) do
				...
				if not typeSuccess then
					return false, string.format("[strictArray] Array index #%d - %s", idx, typeErrMsg :: string)
				end
			end
...
--[[**
		...
		@returns A function that will return true if the condition is passed
	**--]]
	function t.union(...: CheckFunction): CheckFunction
		local checks = { ... }
...
--[[**
		...
		@returns A function that will return true if the condition is passed
	**--]]
	function t.intersection(...: CheckFunction): CheckFunction
		local checks = { ... }
		assert(callbackArray(checks))
...
--[[**
	...
	@returns A function that will return true if the condition is passed
**--]]
function t.literal(...: any): CheckFunction
	local size = select("#", ...)
	if size == 1 then
		local literal = ...
		return function(value)
...
--[[**
	...
	@returns True if the condition is satisfied, false otherwise
**--]]
function t.keyOf(keyTable: { [any]: any }): CheckFunction
	local keys = {}
	local length = 0
...
--[[**
	...
	@returns True if the condition is satisfied, false otherwise
**--]]
function t.valueOf(valueTable: { [any]: any }): CheckFunction
	local values = {}
	local length = 0
...
--[[**
	...
	@returns A function that will return true if the condition is passed
**--]]
function t.integerMin(min: any): CheckFunction
	return function(value)
		...
		if value >= min then
			...
			return false, string.format("integer >= %s expected, got %s", min, value)
		end
	end
end
...
--[[**
	...
	@returns A function that will return true if the condition is passed
**--]]
function t.integerMax(max: any): CheckFunction
	return function(value)
		local success, errMsg = t.integer(value)
		if not success then
			return false, errMsg
		...
		if value <= max then
			...
			return false, string.format("integer <= %s expected, got %s", max, value)
		end
	end
end
...
--[[**
	...
	@returns A function that will return true if the condition is passed
**--]]
function t.integerMinExclusive(min: any): CheckFunction
	return function(value)
		local success, errMsg = t.integer(value)
		if not success then
			return false, errMsg or ""
...
--[[**
	...
	@returns A function that will return true if the condition is passed
**--]]
function t.integerMaxExclusive(max: any): CheckFunction
	return function(value)
		local success, errMsg = t.integer(value)
		if not success then
			return false, errMsg or ""
...
--[[**
	...
	@returns A function that will return true if the condition is passed
**--]]
function t.integerConstrained(min: any, max: any): CheckFunction
...
--[[**
	...
	@returns A function that will return true if the condition is passed
**--]]
function t.integerConstrainedExclusive(min: any, max: any): CheckFunction
	assert(t.number(min))
	assert(t.number(max))
...
--[[**
	ensures value is an integer where value > 0
...
--[[**
	...
	@returns A function that will return true if the condition is passed
**--]]
function t.numberMin(min: any): CheckFunction
	return function(value)
		local success, errMsg = t.number(value)
		if not success then
			return false, errMsg or ""
...
--[[**
	...
	@returns A function that will return true if the condition is passed
**--]]
function t.numberMax(max: any): CheckFunction
	return function(value)
		local success, errMsg = t.number(value)
		if not success then
			return false, errMsg
...
--[[**
	...
	@returns A function that will return true if the condition is passed
**--]]
function t.numberMinExclusive(min: any): CheckFunction
	return function(value)
		local success, errMsg = t.number(value)
		if not success then
			return false, errMsg or ""
...
--[[**
	...
	@returns A function that will return true if the condition is passed
**--]]
function t.numberMaxExclusive(max: any): CheckFunction
	return function(value)
		local success, errMsg = t.number(value)
		if not success then
			return false, errMsg or ""
...
--[[**
	...
	@returns A function that will return true if the condition is passed
**--]]
function t.numberConstrained(min: any, max: any): CheckFunction
	assert(t.number(min))
	assert(t.number(max))
...
--[[**
	...
	@returns A function that will return true if the condition is passed
**--]]
function t.numberConstrainedExclusive(min: any, max: any): CheckFunction
	assert(t.number(min))
	assert(t.number(max))
...
--[[**
	...
	@returns A function that will return true if the condition is passed
**--]]
function t.match(pattern: any): CheckFunction
...
--[[**
	...
	@returns A function that will return true if the condition is passed
**--]]
function t.optional(check: CheckFunction): CheckFunction
	assert(t.callback(check))
	return function(value)
		if value == nil then
			return true
...
--[[**
	...
	@returns A function that will return true if the condition is passed
**--]]
function t.tuple(...: CheckFunction): CheckFunction
	local checks = { ... }
	return function(...)
		local args = { ... }
...
--[[**
	...
	@returns A function that will return true if the condition is passed
**--]]
function t.map(keyCheck: CheckFunction, valueCheck: CheckFunction): CheckFunction
...
--[[**
	...
	@returns A function that will return true if the condition is passed
**--]]
function t.set(valueCheck: CheckFunction): CheckFunction
...
--[[**
		...
		@returns A function that will return true if the condition is passed
	**--]]
	function t.interface(checkTable: { [any]: any }): CheckFunction
...
--[[**
		...
		@returns A function that will return true if the condition is passed
	**--]]
	function t.strictInterface(checkTable: { [any]: any }): CheckFunction
		assert(checkInterface(checkTable))
		return function(value)
			local tableSuccess, tableErrMsg = t.table(value)
			if tableSuccess == false then
...
--[[**
	...
	**--]]
	function t.children(checkTable: { [any]: any }): CheckFunction
...
--[[**
	...
	@returns A function that will return true if the condition is passed
**--]]
function t.instanceOf(className: string, childTable: { [any]: any }?): CheckFunction
...
--[[**
	...
	@returns A function that will return true if the condition is passed
**--]]
function t.instanceIsA(className: string, childTable: { [any]: any }?): CheckFunction
	assert(t.string(className))
...
--[[**
	...
	@returns A function that will return true if the condition is passed
**--]]
function t.enum(enum: any): CheckFunction
	assert(t.Enum(enum))
	return function(value)
...
--[[**
	...
	**--]]
	function t.wrap(callback: any, checkArgs: CheckFunction): CheckFunction
...
**--]]
function t.strict(check: CheckFunction): (...any) -> ()
	return function(...)
		assert(check(...))
	end
end
